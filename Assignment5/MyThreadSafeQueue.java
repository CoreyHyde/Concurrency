public class MyThreadSafeQueue <T> implements FifoQueue <T> {
   ...
   */
    ...
    public synchronized void enqueue(T item) {    // note: never fails
    ...
    public synchronized T dequeue() {   // returns null if empty
        if (this.first==null) {
            return null;
    ...
    public synchronized int getQueueLength() { // returns number currently in queue
        return this.length;
    }
